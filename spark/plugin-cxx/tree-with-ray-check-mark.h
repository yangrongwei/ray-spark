...
/* Here is how primitive or already-canonicalized types' hash codes
   are made.  */
/*Ray:Hok(tree_type), CPPok */ #define TYPE_HASH(TYPE) (TYPE_UID (TYPE))

/* A simple hash function for an arbitrary tree node.  This must not be
   used in hash tables which are saved to a PCH.  */
/*Ray:Hok(tree_base), */ #define TREE_HASH(NODE) ((size_t) (NODE) & 0777777)
...
/*Ray:Hok(tree_base), */#define INTEGRAL_TYPE_P(TYPE)  \
...
/*H,*/#define VL_EXP_OPERAND_LENGTH(NODE) \
...
/* In a LOOP_EXPR node.  */
/*H,*/#define LOOP_EXPR_BODY(NODE) TREE_OPERAND_CHECK_CODE (NODE, LOOP_EXPR, 0)
...
/*Ray:Hok,*/#define TYPE_UID(NODE) (TYPE_CHECK (NODE)->type.uid)
